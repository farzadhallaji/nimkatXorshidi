...
public class CityDetailActivity extends BaseActivity {
    ...
    public static final String TRANSITION_NAME = "com.hallaji.farzad.nimkatxorshidi.transition_name";
    public static final String IMAGE_NAME = "com.hallaji.farzad.nimkatxorshidi.image_name";
