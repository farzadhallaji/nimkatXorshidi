package com.hallaji.farzad.nimkatxorshidi.adapter;
...
import com.hallaji.farzad.nimkatxorshidi.data.model.DayPager;
import com.hallaji.farzad.nimkatxorshidi.fragment.DayWeatherFragment;
...
public class DaysViewPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public DaysViewPagerAdapter(FragmentManager fm, ArrayList<DayPager> days) {
        super(fm);
        mDays = days;
    }
